...
?>
	<header>
		...
		<?php  
			$newIcon = get_post_meta(get_the_ID(), 'page_title_icon', true);
			$defIcon = get_stylesheet_directory_uri().'/images/tooth-man.png';
			$useImage = $newIcon != "" ? $newIcon : $defIcon;
		?>
		<span style="background-image: url(<?php echo $useImage ?>)" class="page-title-icon">Icon</span>
	</header>
